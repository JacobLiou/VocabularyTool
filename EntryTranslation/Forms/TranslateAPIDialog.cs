using EntryTranslation.Configs;
using EntryTranslation.Properties;
using Sunny.UI;

namespace EntryTranslation.Forms
{
    public partial class TranslateAPIDialog : UIForm
    {
        ...
        public TranslateAPIDialog(List<string> languages, string[] googleLanguages) : this()
        {
            ...
            _languagesFrom = new List<string> { EntryTranslation.Properties.Resources.ColNameNoLang };
            _languagesFrom.AddRange(_languages);

            _languagesTo = new List<string> { EntryTranslation.Properties.Resources.ColNameNoLang };
        ...
        {
            bool isSourceDefaultLanguage = (string)cbSourse.SelectedItem == EntryTranslation.Properties.Resources.ColNameNoLang;
            bool isTargetDefaultLanguage = (string)cbTarget.SelectedItem == EntryTranslation.Properties.Resources.ColNameNoLang;
